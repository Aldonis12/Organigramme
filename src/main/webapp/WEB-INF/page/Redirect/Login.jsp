...
<% if (request.getAttribute("alerte")!=null){%>
        alert("<%=request.getAttribute("alerte") %>")
<% } %>
</script>
...
<div class="wrapper vh-100">
    <div class="row align-items-center h-100">
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" action="<%=request.getContextPath()%>/LoginSociete" method="post">
            ...
            <h1 class="h6 mb-3">Se connecter / <a href="<%= request.getContextPath() %>/AddSociete">S'inscrire</a></h1>
            <div class="form-group">
                <label class="sr-only">Email</label>
                <input type="email" name="mail" class="form-control form-control-lg" placeholder="Email">
            </div>
            <div class="form-group">
